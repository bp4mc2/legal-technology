...
### Documentatie
- **Documentatiehub** — centrale ingang voor gegenereerde catalogusdocumentatie (catalogus, taxonomieen, organisaties, ontologie, generatieverantwoording)
...
| Documentatiehub | `/documentation` | Generated documentation hub for catalogus, taxonomieen, organisaties, ontologie, and provenance |
...
| Documentatiehub | `/documentation` | Implemented baseline: generated documentation section navigation, source labeling, stale-generation cue |
...
| 6 | Documentation Experience Expansion | Documentation hub, generated docs navigation, source labeling, and dashboard integration | Implemented baseline |
...
**Technologiedocumentatie** — sourced from `tools/generate_respec.py` output under `build/docs/` (published as static artifacts in `dist/`). Each item shows filename, source label ("ReSpec gegenereerd"), and opens inline in the rail or as standalone artifact.
