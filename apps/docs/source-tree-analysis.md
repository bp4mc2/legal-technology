...
├── apps/docs/                    # Analyse- en projectdocumentatie
...
├── build/                   # Tijdelijke build-artifacts voor documentatiegeneratie
├── dist/                    # Statische publicatie-output (site/assets/pdf)
├── media/                   # Legacy visualisatie-output (niet de primaire ReSpec-doc bron)
...
- De `apps/docs/`-, `model/`- en `data/`-lagen vormen samen de kennis- en documentatiebasis.
